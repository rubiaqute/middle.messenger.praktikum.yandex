...
export type ChangePasswordModeProfileInputs = Extract<ProfileInputs, ProfileInputs.ProfileInputRepeatNewPassword | ProfileInputs.ProfileInputNewPassword | ProfileInputs.ProfileInputOldPassword>
export type EditModeProfileInputs = Exclude<ProfileInputs, ChangePasswordModeProfileInputs>

export type FilledProfileInputs = Exclude<ProfileInputs, ProfileInputs.ProfileInputRepeatNewPassword | ProfileInputs.ProfileInputNewPassword>
...
export type ChangePasswodProfileForm = Record<ChangePasswordModeProfileInputs, string>
